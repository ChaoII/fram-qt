    ...
    ui(new Ui::FaceInfoWidget)
{
    ...
    connect(register_widget, &RegisterWidget::register_finished_signal, this, &FaceInfoWidget::handle_register_finished);
...
{
    the_model->clear();
    the_model->setHorizontalHeaderLabels(QStringList()<<""<<"编号"<<"ID"<<"姓名"<<"工号"<<"注册时间"<<"图片");
